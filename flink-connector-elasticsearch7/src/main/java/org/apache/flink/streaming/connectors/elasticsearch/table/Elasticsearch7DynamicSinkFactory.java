...
import static org.apache.flink.streaming.connectors.elasticsearch.table.ElasticsearchConnectorOptions.UPDATE_EXCLUDE_FIELD_KEY_OPTION;
...
public class Elasticsearch7DynamicSinkFactory implements DynamicTableSinkFactory {
    ...
    private static final Set<ConfigOption<?>> optionalOptions =
            Stream.of(
                            ...
                            PASSWORD_OPTION,
                            USERNAME_OPTION,
                            UPDATE_EXCLUDE_FIELD_KEY_OPTION)
